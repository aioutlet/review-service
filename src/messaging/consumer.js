...
class Consumer {
   ...
   */
  async handleOrderCompleted(message, correlationId) {
    try {
   ...
   * @param {String} correlationId - Request correlation ID
   */
  async handleUserDeleted(message, correlationId) {
    try {
      const log = logger.withCorrelationId(correlationId);
   ...
   * @param {String} correlationId - Request correlation ID
   */
  async handleProductDeleted(message, correlationId) {
    try {
      const log = logger.withCorrelationId(correlationId);
   ...
   * @param {String} correlationId - Request correlation ID
   */
  async handleProductUpdated(message, correlationId) {
    try {
      const log = logger.withCorrelationId(correlationId);
   ...
   * @param {String} correlationId - Request correlation ID
   */
  async handleUserUpdated(message, correlationId) {
    try {
      const log = logger.withCorrelationId(correlationId);
   ...
   * @param {String} correlationId - Request correlation ID
   */
  handleConsumerError(error, eventType, message, correlationId) {
